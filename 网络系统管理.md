...
```bash
服务端
nmcli connection modify ens160 autoconnect yes method none ipv4.addresses 192.168.10.10/24 ipv4.gateway 192.168.10.254 ipv4.dns 127.0.0.1
nmcli connection down
nmcli connection up 
客户端
nmcli connection modify ens160 autoconnect yes method none ipv4.addresses 192.168.10.20/24 ipv4.gateway 192.168.10.254 ipv4.dns 192.168.10.10
nmcli connection down
nmcli connection up 
```
